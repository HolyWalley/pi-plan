...
const AgentScopeSchema = StringEnum(["package", "user", "project", "both", "all"] as const, {
	description: 'Which agent directories to use. Default: "package". Use "all" to include bundled, user, and project-local agents.',
	default: "package",
});
...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		description: [
			...
			"Default agent scope is package (bundled agents from pi-plan).",
			`To enable project-local agents in ${CONFIG_DIR_NAME}/agents, set agentScope: "project", "both", or "all".`,
		].join(" "),
		...
		async execute(_toolCallId, params, signal, onUpdate, ctx) {
			...
			if ((agentScope === "project" || agentScope === "both" || agentScope === "all") && confirmProjectAgents && ctx.hasUI) {
